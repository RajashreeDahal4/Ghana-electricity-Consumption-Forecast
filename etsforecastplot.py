...
predictions = file['ETS Prediction'][:40]
...
MAPE(file["Actual"],file["ETS Prediction"])
...
plt.plot(file["Year"],file["ETS Prediction"],label="ETS Prediction")
